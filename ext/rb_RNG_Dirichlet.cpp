...
VALUE method_rb_RNG_Dirichlet_get_alphas_ (VALUE self) {
	rb_RNG_Dirichlet * r;
	Data_Get_Struct(self, rb_RNG_Dirichlet, r);
	
	return realvector_to_rb_ary(r->getModel()->alphas_());
}
...
void Init_rb_RNG_Dirichlet () {
	...
	rb_define_method(rb_RNG_Dirichlet::rb_class(), "alphas_", (rb_method) method_rb_RNG_Dirichlet_get_alphas_, 0);
