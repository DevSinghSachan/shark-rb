...
VALUE method_rb_RNG_Dirichlet_set_alphass (VALUE self, VALUE parameter_1, VALUE parameter_2) {
	rb_RNG_Dirichlet * r;
...
void Init_rb_RNG_Dirichlet () {
	rb_define_method(rb_RNG_Dirichlet::rb_class(), "alphass=", (rb_method) method_rb_RNG_Dirichlet_set_alphass, 2);
