...
VALUE method_rb_RNG_Dirichlet_florida (VALUE self, VALUE parameter_1, VALUE parameter_2, VALUE parameter_3, VALUE parameter_4) {
	rb_RNG_Dirichlet *r;
	...
	// Checking whether parameter_3 is a "matrix"
	if (TYPE(parameter_3) != T_ARRAY || (RARRAY_LEN(parameter_3) > 0 && TYPE(rb_ary_entry(ary, 0))) != T_ARRAY || (RARRAY_LEN(parameter_3) > 0 && RARRAY_LEN(rb_ary_entry(parameter_3, 0)) > 0 && TYPE(rb_ary_entry(rb_ary_entry(parameter_3, 0), 0)) != T_FLOAT && TYPE(rb_ary_entry(rb_ary_entry(parameter_3, 0), 0)) != T_FIXNUM) && CLASS_OF(parameter_3) != rb_RealMatrix::rb_class() && CLASS_OF(parameter_3) != rb_RealMatrixReference::rb_class())
		rb_raise(rb_eArgError, "Argument 3 must be an MatrixType (\"RealMatrix\", \"RealMatrixReference\", \"Array< Array< Float > >\").");

	// Checking whether parameter_4 is a "matrix"
	if (TYPE(parameter_4) != T_ARRAY || (RARRAY_LEN(parameter_4) > 0 && TYPE(rb_ary_entry(ary, 0))) != T_ARRAY || (RARRAY_LEN(parameter_4) > 0 && RARRAY_LEN(rb_ary_entry(parameter_4, 0)) > 0 && TYPE(rb_ary_entry(rb_ary_entry(parameter_4, 0), 0)) != T_FLOAT && TYPE(rb_ary_entry(rb_ary_entry(parameter_4, 0), 0)) != T_FIXNUM) && CLASS_OF(parameter_4) != rb_RealMatrix::rb_class() && CLASS_OF(parameter_4) != rb_RealMatrixReference::rb_class())
		rb_raise(rb_eArgError, "Argument 4 must be an MatrixType (\"RealMatrix\", \"RealMatrixReference\", \"Array< Array< Float > >\").");

	// Converting parameters "parameter_1", "parameter_3", "parameter_4" before they can be used.
	if (TYPE(parameter_1) == T_ARRAY) {
		RealVector parameter_1_converted = rb_ary_to_1d_realvector(parameter_1);
		if (TYPE(parameter_3) == T_ARRAY) {
			RealMatrix parameter_3_converted = rb_ary_to_realmatrix(parameter_3);
			if (TYPE(parameter_4) == T_ARRAY) {
				RealMatrix parameter_4_converted = rb_ary_to_realmatrix(parameter_4);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(parameter_1_converted, rb_float_new(parameter_2), parameter_3_converted, parameter_4_converted)));;
			} else if (CLASS_OF(parameter_4) == rb_RealMatrix::rb_class()) {
				rb_RealMatrix * parameter_4_converted;
				Data_Get_Struct(parameter_4, rb_RealMatrix, parameter_4_converted);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(parameter_1_converted, rb_float_new(parameter_2), parameter_3_converted, *(parameter_4_converted->getData()))));;
			} else if (CLASS_OF(parameter_4) == rb_RealMatrixReference::rb_class()) {
				rb_RealMatrixReference * parameter_4_converted;
				Data_Get_Struct(parameter_4, rb_RealMatrixReference, parameter_4_converted);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(parameter_1_converted, rb_float_new(parameter_2), parameter_3_converted, *(parameter_4_converted->getData()))));;
			}
		} else if (CLASS_OF(parameter_3) == rb_RealMatrix::rb_class()) {
			rb_RealMatrix * parameter_3_converted;
			Data_Get_Struct(parameter_3, rb_RealMatrix, parameter_3_converted);
			if (TYPE(parameter_4) == T_ARRAY) {
				RealMatrix parameter_4_converted = rb_ary_to_realmatrix(parameter_4);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(parameter_1_converted, rb_float_new(parameter_2), *(parameter_3_converted->getData()), parameter_4_converted)));;
			} else if (CLASS_OF(parameter_4) == rb_RealMatrix::rb_class()) {
				rb_RealMatrix * parameter_4_converted;
				Data_Get_Struct(parameter_4, rb_RealMatrix, parameter_4_converted);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(parameter_1_converted, rb_float_new(parameter_2), *(parameter_3_converted->getData()), *(parameter_4_converted->getData()))));;
			} else if (CLASS_OF(parameter_4) == rb_RealMatrixReference::rb_class()) {
				rb_RealMatrixReference * parameter_4_converted;
				Data_Get_Struct(parameter_4, rb_RealMatrixReference, parameter_4_converted);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(parameter_1_converted, rb_float_new(parameter_2), *(parameter_3_converted->getData()), *(parameter_4_converted->getData()))));;
			}
		} else if (CLASS_OF(parameter_3) == rb_RealMatrixReference::rb_class()) {
			rb_RealMatrixReference * parameter_3_converted;
			Data_Get_Struct(parameter_3, rb_RealMatrixReference, parameter_3_converted);
			if (TYPE(parameter_4) == T_ARRAY) {
				RealMatrix parameter_4_converted = rb_ary_to_realmatrix(parameter_4);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(parameter_1_converted, rb_float_new(parameter_2), *(parameter_3_converted->getData()), parameter_4_converted)));;
			} else if (CLASS_OF(parameter_4) == rb_RealMatrix::rb_class()) {
		...
		if (TYPE(parameter_3) == T_ARRAY) {
			...
			if (TYPE(parameter_4) == T_ARRAY) {
				RealMatrix parameter_4_converted = rb_ary_to_realmatrix(parameter_4);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(*(parameter_1_converted->getData()), rb_float_new(parameter_2), parameter_3_converted, parameter_4_converted)));;
			} else if (CLASS_OF(parameter_4) == rb_RealMatrix::rb_class()) {
				rb_RealMatrix * parameter_4_converted;
				Data_Get_Struct(parameter_4, rb_RealMatrix, parameter_4_converted);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(*(parameter_1_converted->getData()), rb_float_new(parameter_2), parameter_3_converted, *(parameter_4_converted->getData()))));;
			} else if (CLASS_OF(parameter_4) == rb_RealMatrixReference::rb_class()) {
				rb_RealMatrixReference * parameter_4_converted;
				Data_Get_Struct(parameter_4, rb_RealMatrixReference, parameter_4_converted);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(*(parameter_1_converted->getData()), rb_float_new(parameter_2), parameter_3_converted, *(parameter_4_converted->getData()))));;
			...
			if (TYPE(parameter_4) == T_ARRAY) {
				RealMatrix parameter_4_converted = rb_ary_to_realmatrix(parameter_4);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(*(parameter_1_converted->getData()), rb_float_new(parameter_2), *(parameter_3_converted->getData()), parameter_4_converted)));;
			} else if (CLASS_OF(parameter_4) == rb_RealMatrix::rb_class()) {
				rb_RealMatrix * parameter_4_converted;
				Data_Get_Struct(parameter_4, rb_RealMatrix, parameter_4_converted);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(*(parameter_1_converted->getData()), rb_float_new(parameter_2), *(parameter_3_converted->getData()), *(parameter_4_converted->getData()))));;
			} else if (CLASS_OF(parameter_4) == rb_RealMatrixReference::rb_class()) {
				rb_RealMatrixReference * parameter_4_converted;
				Data_Get_Struct(parameter_4, rb_RealMatrixReference, parameter_4_converted);
				return wrap_pointer<rb_RealMatrix>(rb_RealMatrix::rb_class(), new rb_RealMatrix(r->getModel()->florida(*(parameter_1_converted->getData()), rb_float_new(parameter_2), *(parameter_3_converted->getData()), *(parameter_4_converted->getData()))));;
...
void Init_rb_RNG_Dirichlet () {
	...
	rb_define_method(rb_RNG_Dirichlet::rb_class(), "florida", (rb_method) method_rb_RNG_Dirichlet_florida, 4);
}