...
VALUE method_rb_RNG_Uniform_set_range (VALUE self, VALUE parameter_1) {
	rb_RNG_Uniform *r;
...
void Init_rb_RNG_Uniform () {
	...
	rb_define_method(rb_RNG_Uniform::rb_class(), "set_range", (rb_method) method_rb_RNG_Uniform_set_range, 1);
