...
target_prefix = 
LOCAL_LIBS = 
LIBS = $(LIBRUBYARG_SHARED) -lstdc++ -lboost_serialization-mt -lboost_thread-mt -lblas -lshark  -lpthread -ldl -lobjc 
SRCS = Optimizer.cpp rb_RealVector.cpp rb_shark.cpp rb_UnlabeledData.cpp
OBJS = Optimizer.o rb_RealVector.o rb_shark.o rb_UnlabeledData.o
TARGET = rb_shark
